import { Controller, Post, Get, Param, Body, Put, Delete, Query, UseGuards } from '@nestjs/common';
...
export class UserController {
  ...
  @Post('login')
  async login(@Body() loginDto: LoginDto): Promise<{ accessToken: string, timestamp: number, userId: number,fullName:string }> {
